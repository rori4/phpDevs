...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2016 at 10:14 PM
...
(13, 'test', '2016-12-18 17:35:37', 27, 17),
(14, 'test', '2016-12-18 17:40:56', 27, 17),
(15, 'testing last', '2016-12-18 17:47:36', 27, 10),
(16, 'testing last', '2016-12-18 18:02:54', 27, 10),
(17, 'test comments', '2016-12-19 15:13:30', 18, 12),
(18, 'test', '2016-12-19 16:44:35', 27, 19),
(19, 'testing to comment\r\n', '2016-12-19 23:35:16', 27, 14),
(20, '', '2016-12-20 00:38:06', 29, 21),
(21, '', '2016-12-20 00:38:13', 29, 21),
(22, '', '2016-12-20 00:55:36', 18, 21),
(23, '', '2016-12-20 12:57:50', 18, 21);
...
(19, 'EDITED POST  dsadasdas test ', '<p style="text-align: center;">EDITED POSTdsadsadasdas</p>', '2016-12-19 03:28:41', 18),
(20, 'test', '<p>test</p>', '2016-12-19 17:07:03', 18),
(21, 'test', '<p>test</p>', '2016-12-20 00:07:12', 29),
(22, 'sda', '<p>dsa</p>', '2016-12-20 13:00:13', 18),
(23, 'NEW POST 1', '<p>NEW POST</p>', '2016-12-20 13:00:26', 18),
(24, 'dsa', '<p>dsa</p>', '2016-12-20 13:02:51', 27),
(25, 'testing edit', '<p>testing edit</p>', '2016-12-20 13:09:26', 34);
...
INSERT INTO `users` (`id`, `username`, `email`, `password_hash`, `full_name`, `user_role`) VALUES
(2, 'nakov', '14@gmail.com', '$2y$10$XViubT.zSoBtskZmKl6kdOX8Yq7T7tLrcrLn/5dkAqbgjVACeFUGe', 'Svetlin Nakov', 'user'),
(3, 'maria', '1@gmail.com', '$2y$10$gzlpX/N5apTruTBajMJwM.0h9OgLVgQxk6N0YhGy2iY4BI73SYkKO', 'Maria Ivanova', ''),
(5, 'joe', '15@gmail.com', '$2y$10$aIOC0qiNK1mjZdUUbuj/Teh49VI/g9xanuWCNYEUruwcvOGVaXOGK', 'Joe Green', 'user'),
(6, 'test', '16@gmail.com', '$2y$10$I5y7X1ZilitEZYOztOI5SuA2rBeRJUj/ZhlgmSZK32LPqaqh3Gy3q', '', 'user'),
(7, 'it''s security "test"<br>', '17@gmail.com', '$2y$10$thSx6ceSyCPxdl.BDGLhKe7lQu8d3oopQ/LJYK8ma.Dz6jWbOgj8C', 'it''s security "test"<br>', 'user'),
(8, 'vikash', '18@gmail.com', '$2y$10$Exc5mMcThOlEnXZ2.kAPl.ouBSDl8S0GjD.3vvB6KohMpcgfsLsde', 'Vikash Jain', 'user'),
(10, 'nakov2', '19@gmail.com', '$2y$10$e51YTKozE7ny1uDyFLMJRek.cMLaNOJ8yc.5VjFzljAb06wmoF/HW', 'nakov', 'user'),
(12, 'testing_1', '2@gmail.com', '$2y$10$4pfrxwNzFA5RW16id6oML.VkJsZrq6PR4nNa.RAnJQVBf2UiBsH2.', 'nakov', 'admin'),
(17, 'ran', '20@gmail.com', '$2y$10$Z/bzHjPwe/OPKD3N5amLze87U2/hmxrEHCIa0DuN92ltTYzfQxpaS', 'ran', 'user'),
(18, 'nik', '21@gmail.com', '$2y$10$S60WQXeFOFbSpmNVCbZNxea5bogHkWoku7cEXnr3KTaeM9Ol6DxOi', 'nik', 'user'),
(20, 'nikola', '3@gmail.com', '$2y$10$rSYBlQOhc8v/mP2DfMWz.eGR6IDLKv272dufXYEe6c8iLV7JVaYSC', 'nikola', 'admin'),
(21, 'nikst', '4@gmail.com', '$2y$10$Rljg9BKWS2pLcDBpuUyHjOp10jsDjfkIQxGgXyX5eODEueoX9gFm.', 'nikst', 'admin'),
(22, 'baypesho', '22@gmail.com', '$2y$10$piRwJFxq2x9ADnWXOJNCKuYW77lbd3q86.9w/CqtFGa7g8kuZ3SwK', 'baypesho', 'user'),
(23, 'test3', '23@gmail.com', '$2y$10$GbrXsB4LPkFoe4WeYc0XuO0VKf5aahBA/yDbYghfp4mjx.x1zV6V.', 'test', 'user'),
(24, 'nikolastoilov', '24@gmail.com', '$2y$10$GdvJAzicmSChAoJfb1VPaOT19sZ7s8oZmaDHO9V/RORtGxzh9ldpC', 'nikolastoilov', 'user'),
(25, 'adminT', '5@gmail.com', '$2y$10$SRmxPVp3zMdLn/gteRk1Y.la0A4whDwkM2cgtE/mlHeh6m.ZJ4drq', 'adminT', 'admin'),
(26, 'userT', '25@gmail.com', '$2y$10$cUZfEnEo5VZj7kQEY0Pj5upjPgHYbW7k4nZDC56G9VDGn0qB32i8.', 'userT', 'user'),
(27, 'admin', '6@gmail.com', '$2y$10$E0Iui1f6P.nMePG/a.OPNuCv6CPPvStPCEanICHeAj7o3U7a8sIH2', 'admin', 'admin'),
(28, 'rangel', '7@gmail.com', '$2y$10$pdz0UZSWZ6fxaPQ2VG9ZkuwALmkglYwRCEaEm7X1LdaJr9q3N5.kC', 'rangel', 'admin'),
(29, 'new', '26@gmail.com', '$2y$10$R9s4FjGI01UqxWdbo36Rh.Kbd8QS0V5LdoIzX5DMSiWU7.M5eB6NK', 'new', 'user'),
(31, 'rori4', '8@gmail.com', '$2y$10$/0u88X2v07oZNx0eL7Bmxu9cwL.PCIyHmS2FC06fVg3P2g1EiyEGa', 'rori4', 'admin'),
(33, 'rang', '9@gmail.com', '$2y$10$39b5kElV/lrtHsX3TQ2IFe4AIZCmEGrjMWH.iOttGj..HDykKDSbW', 'ran', 'admin'),
(34, '123', '27@gmail.com', '$2y$10$adsxm..pxSfZra.c2UG9y.doZiDfSv81B5w0BBniXNh40sNMpYPgC', '123', 'user'),
(35, '22', '10@gmail.com', '$2y$10$gWTw0Mhe9KhVZZa1BgoHl.nMhY8psDJYfY3OcuuorRbd7m2wAWFUq', '22', 'admin'),
(36, '33', '11@gmail.com', '$2y$10$ui9RkqoJj9XR.9zArRHYnO1hUe4O9i.Jjg.OWOc8lgD.DD/rpI0K2', '33', 'admin'),
(37, '44', '12@gmail.com', '$2y$10$xEjn8xdZ8FisvgRoMYrAfuG7s2x66DXBDQb1yobqnsnYFwgRnyTFi', '44', 'admin'),
(38, '55', '13@gmail.com', '$2y$10$TVHKOygzzaPJv.tZzr8INuv/.6cHJ5sIWNfK19/uuYtpdJrNK7dTG', '55', 'admin'),
(40, 'rangel1234', 'rangelstoilov@gmail.com', '$2y$10$RJDn4SzGJd4SvqTHSmLuSejScE1oXfMTEq17qpRGBoIWk8ObYN8Ea', 'Rangel Stoilov', 'admin');
